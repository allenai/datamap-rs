...
# Step -1:
TARGET_DIR="s3://ai2-llm/pretraining-data/sources/cc_all_dressed/all_dressed_v3/minhash/param_26_11/groups/$X/"
...
s5cmd cp -sp "s3://ai2-llm/pretraining-data/sources/cc_all_dressed/all_dressed_v3/minhash/param_26_11/annotated/${X}/*" "/mnt/raid0/input/"
...
cargo run --release -- dist-group --input-dir /mnt/raid0/input --group-dir /mnt/raid0/groups --config examples/all_dressed/minhash_groupsort.yaml  --subext "${X}" > "/mnt/raid0/group_${X}.log"
