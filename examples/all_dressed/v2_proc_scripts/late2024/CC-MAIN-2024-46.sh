...
# Step -1:
TARGET_DIR="s3://ai2-llm/pretraining-data/sources/cc_all_dressed/all_dressed_v2/english/$X/"
...
s5cmd cp -sp "s3://ai2-llm/pretraining-data/sources/dclm/pool/documents/$X/*" "/mnt/raid0/$X"
