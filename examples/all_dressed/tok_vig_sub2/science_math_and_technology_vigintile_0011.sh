X="science_math_and_technology/vigintile_0011"
...
# Step 1: reshard 
cd ~/datamap-rs 
cargo run --release -- reshard --input-dir /mnt/raid0/input --output-dir /mnt/raid0/resharded --max-size 256000000 --subsample 0.035
...
s5cmd cp -sp /mnt/raid0/resharded/ "s3://ai2-llm/pretraining-data/sources/cc_all_dressed/all_dressed_v3_subsamples/vigintile_subsamples_0.035/data/${X}/"
s5cmd cp -sp /mnt/raid0/tokens/ "s3://ai2-llm/pretraining-data/sources/cc_all_dressed/all_dressed_v3_subsamples/vigintile_subsamples_0.035/tokens/${X}/"