...
ALL_SOURCES=(
    "tokyotech-llm_swallow-math-v2/stage3-texbook_decon_ngram_filtered"
    "tokyotech-llm_swallow-math-v2/stage3-qa_decon_ngram_filtered"
    "tokyotech-llm_swallow-code-v2/stage5_python_medium_decon_ngram_filtered"
