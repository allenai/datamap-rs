...
ALL_SOURCES=(
    "tokyotech-llm_swallow-math-v2/stage3-texbook_decon"
    "tokyotech-llm_swallow-math-v2/stage3-qa_decon"
    "tokyotech-llm_swallow-code-v2/stage5_python_medium_decon"
    "finemath/finemath-3plus-decon-sparkle"
)
