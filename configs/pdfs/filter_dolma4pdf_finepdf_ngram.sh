...
BASE_SOURCES="pretraining-data/sources/dolma4pdfs/dolma4pdfs_full_deduped_partitioned_resharded_qualitytagged_partitioned_decon/finepdfs_wo_partitioned_qual"
ALL_SOURCES=(
