...
BASE_DIR="pretraining-data/sources/the-stack-v2/spring2code_v2/minhash_filter_v2_2026_stack_edu_redux_tagged_decon_reshard_partitioned_gzip_ngram_filtered"
...
for source in "${SOURCES[@]}"; do
    ...
    # until there's a directory called "step_final", replace local_input_dir with step_final;
